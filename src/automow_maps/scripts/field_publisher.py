...
class FieldPublisherNode(object):
    ...
    def __init__(self):
        ...
        safety_pub = rospy.Publisher('/field/safety', PolygonStamped, queue_size=10, latch=True)
        boundry_pub = rospy.Publisher('/field/boundry', PolygonStamped, queue_size=10, latch=True)
        cut_area_pub = rospy.Publisher('/field/cut_area', PolygonStamped, queue_size=10, latch=True)
